...
def create_research_tasks(topic: str, researcher: Agent) -> List[Task]:
    ...
    initial_search = Task(
        ...
        - Identify and curate a list of 20-30 key papers essential to the review.
        - Extract and document metadata (title, authors, year) along with concise summaries.
        - Organize papers based on relevance and impact on the topic.
